    ...
    return (
      <div className="flex-center" style={{ minHeight: '80vh' }}>
        <div className="glass-panel auth-panel flex-col-center" style={{ maxWidth: 500, gap: 24, textAlign: 'center' }}>
          <div style={{ width: 80, height: 80, borderRadius: '50%', background: 'rgba(var(--neon-cyan-rgb),0.08)', border: '1px solid rgba(var(--neon-cyan-rgb),0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div className="glass-panel font-mono" style={{ padding: 24, fontSize: 12, color: 'var(--text-muted)', lineHeight: 1.8 }}>
      ...
      <div className="glass-panel auth-panel" style={{ width: '100%', maxWidth: 500 }}>
        ...
        <div className="flex-col-center" style={{ gap: 32, textAlign: 'center' }}>
          ...
          <div>
            ...
            <p className="font-mono" style={{ fontSize: 11, color: 'var(--text-muted)', letterSpacing: 3 }}>ENROLLMENT PROTOCOL</p>
          </div>
          ...
          <form onSubmit={handleRegister} style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 20 }}>
            <div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <Mail size={18} style={{ position: 'absolute', right: 16, top: 18, color: 'var(--text-muted)' }} />
              </div>
            </div>
            <div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <Lock size={18} style={{ position: 'absolute', right: 16, top: 18, color: 'var(--text-muted)' }} />
              </div>
            </div>
          ...
          <div style={{ borderTop: '1px solid var(--glass-border)', paddingTop: 24, width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span style={{ color: 'var(--text-muted)', fontSize: 13 }}>Already registered?</span>
